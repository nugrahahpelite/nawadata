...
Public Class CrpSsoSOCycleCount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SBSto.CrpSsoSOCycleCount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpSsoSOCycleCount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpSsoSOCycleCount = New CrpSsoSOCycleCount()
        rpt.Site = Me.Site
        Return rpt
    End Function
