...
Public Class CrpSsoSOTallyRcv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SBSto.CrpSsoSOTallyRcv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpSsoSOTallyRcv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpSsoSOTallyRcv = New CrpSsoSOTallyRcv()
        rpt.Site = Me.Site
        Return rpt
    End Function
