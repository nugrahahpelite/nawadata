<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoPutAwayDsw.aspx.vb" Inherits="SBSto.WbfSsoPutAwayDsw" Title="SB WMS - Putaway Penerimaan Dispatch Gudang Sama" MasterPageFile="~/SBSto.Master" %>
                    ...
                    <asp:Panel ID="PanButtonH" runat="server">
                        <table style="font-family:tahoma;font-size:12px;">
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:Label ID="LblTitle" runat="server" Font-Bold="True" Font-Size="19px" ForeColor="#333333" Text="PUTAWAY PENERIMAAN DISPATCH GUDANG SAMA"></asp:Label>                           
                                </td>
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                ...
                                <td>
                                    <asp:Button ID="BtnCancelDSW" runat="server" class="myButtonAct" Enabled="False" Font-Names="Tahoma" Font-Size="12px" Height="30px" Text="Batal Putaway" Width="120px" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                                    ...
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                         <Columns>
                                                            ...
                                                            <asp:BoundField DataField="DSWCancelNote" HeaderText="Cancel Note">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                            ...
                            <td>
                                <asp:GridView ID="GrvSumm" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                    ...
                                    <Columns>
                                            ...
                                            <%-- 4 --%>
                                            <asp:BoundField DataField="vSumDSWScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 1" HtmlEncode="false">
                                            ...
                                            <%-- 6 --%>
                                            <asp:BoundField DataField="vSumDSWScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 2" HtmlEncode="false">
                                                <HeaderStyle Width="45px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                    </Columns>
                                            ...
                                            <td colspan="6">
                                                <asp:GridView ID="GrvData1" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                                 ...
                                                 <Columns>
                                                        ...
                                                        <%-- 2 --%>
                                                        <asp:BoundField DataField="DSWScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="DSWScan1Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="vDSWScan1User" HeaderText="Scan By">
                                                            <HeaderStyle Width="100px" CssClass="myDisplayNone" />
                                                            <ItemStyle Width="100px" CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        <asp:BoundField DataField="vDSWScan1Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                        ...
                                                        <%-- 7 --%>
                                                        <asp:BoundField DataField="vDSWScan1Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="DSWScan1DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="vDSWScan1DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                ...
                                                <asp:GridView ID="GrvData2" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True" Visible="False">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="DSWScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="DSWScan2Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        <asp:BoundField DataField="vDSWScan2User" HeaderText="Scan By">
                                                            <HeaderStyle CssClass="myDisplayNone" Width="100px" />
                                                            <ItemStyle CssClass="myDisplayNone" Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 6 --%>
                                                        <asp:BoundField DataField="vDSWScan2Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%-- 7 --%>
                                                        ...
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="vDSWScan2Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="DSWScan2DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 10 --%>
                                                        <asp:BoundField DataField="vDSWScan2DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
