<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoDispatchRcvDs.aspx.vb" Inherits="SBSto.WbfSsoDispatchRcvDs" Title="SB WMS - Penerimaan Dispatch" MasterPageFile="~/SBSto.Master" %>
                    ...
                    <asp:Panel ID="PanButtonH" runat="server">
                        <table style="font-family:tahoma;font-size:12px;">
                            <tr>
                                ...
                                <td style="font-size:15px;height:28px" colspan="3"><strong>PENERIMAAN DISPATCH</strong></td>                                
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="BtnCancelDSR" runat="server" class="myButtonAct" Enabled="False" Font-Names="Tahoma" Font-Size="12px" Height="30px" Text="Batal Penerimaan Dispatch" Width="180px" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                    ...
                                    <asp:Panel ID="PanList" class="myPanelGreyNS" runat="server" style="z-index:110;display:block;width:1650px;height:580px" Visible="True" BorderStyle="Solid" BackColor="White">
                                        <table style="width:85%;font-family: tahoma;font-size:11px">
                                            <tr>
                                                ...
                                                <td  style="width:115px;text-align:right">No. : </td>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                &nbsp;&nbsp;
                                                                <asp:CheckBox ID="ChkSt_DispatchDone" runat="server" ForeColor="#336600" Text="Dispatch Receive Done" Checked="True" />
                                                                &nbsp;&nbsp;&nbsp;
                                                                <asp:CheckBox ID="ChkSt_PutawayProcess" runat="server" Checked="True" ForeColor="#336600" Text="Putaway Process" />
                                                                &nbsp;&nbsp;&nbsp;
                                                                <asp:CheckBox ID="ChkSt_All_Putaway_Clomplete" runat="server" ForeColor="#336600" Text="All Putaway Complete" />
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:ButtonField CommandName="DSRNo" DataTextField="DSRNo" HeaderText="No.Penerimaan" Text="Button">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:ButtonField>
                                                            <asp:BoundField DataField="vDSRDate" HeaderText="Tanggal<br />Terima" HtmlEncode="false">
                                                            ...
                                                            <asp:BoundField DataField="DSRCancelNote" HeaderText="Cancel Note">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="vDispatchRcvDone" HeaderText="Receive Confirm" >
                                                                <HeaderStyle Width="145px" />
                                                                <ItemStyle HorizontalAlign="Left" />
                                                            </asp:BoundField>
                                                        </Columns>
