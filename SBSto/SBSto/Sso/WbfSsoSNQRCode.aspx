<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoSNQRCode.aspx.vb" Inherits="SBSto.WbfSsoSNQRCode" MasterPageFile="~/SBSto.Master" Title="SB SO : Print SN QR" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="CtpRight">
    <!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>SB SO : Print SN QR</title>
                            ...
                            <td style="vertical-align:top; width: 585px;">
                                <table style="font-family:tahoma;font-size:12px;">
                                    <tr>
                                        ...
                                        <td style="font-size:15px;height:28px" colspan="5"><strong>PRINT SERIAL NO QR</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Company</td>
                            ...
                            <td style="vertical-align:top;height:100%">
                                <asp:Panel ID="PanList" class="myPanelGreyNSa" runat="server" Width="100%" style="height:500px" Visible="True">
                                    <table style="width: 90%;margin:auto;font-family: tahoma;font-size:11px">
                                        <tr>
                                            <td style="font-size:15px;height:28px" colspan="3"><strong>HISTORY PRINT SERIAL NO QR</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>Barang</td>
                                                        <td>:</td>
                                                        <td><asp:TextBox ID="TxtListBarang" runat="server" Width="245px" Font-Names="Tahoma" Font-Size="12px"></asp:TextBox></td>
                                                        <td></td>
                                                        <td>Serial No.</td>
                                                        <td>:</td>
                                                        <td><asp:TextBox ID="TxtListSN" runat="server" Width="245px" Font-Names="Tahoma" Font-Size="12px"></asp:TextBox></td>
                                            ...
                                            <td>
                                                <asp:GridView class="myPanelGreyLight" ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" ShowHeaderWhenEmpty="True" CssClass="myGridViewHeaderFontWeightNormal" PageSize="25">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="PrintSN" HeaderText="Serial No.">
                                                        ...
                                                        <asp:BoundField DataField="vPrintReq" HeaderText="Print By Request">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="PrintReqOID" HeaderText="Print Request ID">
