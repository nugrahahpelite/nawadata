...
Public Class CrpSsoSummPutw
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SBSto.CrpSsoSummPutw.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpSsoSummPutw
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpSsoSummPutw = New CrpSsoSummPutw()
        rpt.Site = Me.Site
        Return rpt
    End Function
