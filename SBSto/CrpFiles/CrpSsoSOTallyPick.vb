...
Public Class CrpSsoSOTallyPick
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SBSto.CrpSsoSOTallyPick.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpSsoSOTallyPick
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpSsoSOTallyPick = New CrpSsoSOTallyPick()
        rpt.Site = Me.Site
        Return rpt
    End Function
