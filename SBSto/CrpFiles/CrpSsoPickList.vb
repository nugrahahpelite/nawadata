...
Public Class CrpSsoPickList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SBSto.CrpSsoPickList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpSsoPickList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpSsoPickList = New CrpSsoPickList()
        rpt.Site = Me.Site
        Return rpt
    End Function
