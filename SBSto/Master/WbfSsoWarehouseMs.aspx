<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoWarehouseMs.aspx.vb" Inherits="SBSto.WbfSsoWarehouseMs" MasterPageFile="~/SBSto.Master" Title="SB WMS : Master Warehouse" %>
                        ...
                        <tr>
                            <td style="vertical-align:top; width: 585px;">
                                <table style="font-family:tahoma;font-size:12px;">
                                    <tr>
                                        <td></td>
                                        <td style="font-size:15px;height:28px" colspan="3"><strong>MASTER WAREHOUSE</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style3"></td>
                                        <td class="auto-style4">ID Warehouse</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 24px">Kode Warehouse</td>
                                        <td style="height: 24px">:</td>
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px"><asp:TextBox ID="TxtWhsCode" runat="server" Width="100px" Font-Names="Tahoma" Font-Size="12px" MaxLength="5" CssClass="setuppercase"></asp:TextBox></td>
                                                    <td style="height: 20px">
                                            <asp:Label ID="LblMsgWhsCode" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="auto-style2"></td>
                                        <td style="height: 24px">Nama Warehouse</td>
                                        <td style="height: 24px">:</td>
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px"><asp:TextBox ID="TxtWhsName" runat="server" Width="214px" Font-Names="Tahoma" Font-Size="12px" MaxLength="50" CssClass="setuppercase"></asp:TextBox></td>
                                                    <td style="height: 20px">
                                            <asp:Label ID="LblMsgWhsName" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px"><asp:TextBox ID="TxtWhsAddress" runat="server" Width="300px" Font-Names="Tahoma" Font-Size="12px" MaxLength="200" CssClass="setuppercase" Height="45px" TextMode="MultiLine"></asp:TextBox></td>
                                                    <td style="height: 20px">
                                            <asp:Label ID="LblMsgWhsAddress" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px">
                                                        <asp:DropDownList ID="DstCity" runat="server" style="height: 20px" Width="225px">
                                                        </asp:DropDownList>
                                                    </td>
                                                    <td style="height: 20px">
                                            <asp:Label ID="LblMsgWhsCity" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <td style="vertical-align:top;height:100%">
                                <asp:Panel ID="PanList" class="myPanelGreyNSa" runat="server" Width="100%" style="height:500px" Visible="True">
                                    <table style="width: 90%;margin:auto;font-family: tahoma;font-size:11px">
                                        <tr>
                                            <td style="font-size:15px;height:28px" colspan="3"><strong>LIST WAREHOUSE</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView class="myPanelGreyLight" ID="GrvList" runat="server" AutoGenerateColumns="False" Width="945px" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" ShowHeaderWhenEmpty="True" CssClass="myGridViewHeaderFontWeightNormal" PageSize="25">
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="WarehouseCode" HeaderText="Kode Warehouse">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <asp:ButtonField CommandName="Select" DataTextField="WarehouseName" HeaderText="Nama Warehouse">
                                                            <HeaderStyle Width="185px" />
                                                        </asp:ButtonField>
                                                        <asp:BoundField DataField="WarehouseAddress" HeaderText="Alamat">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="CityName" HeaderText="Kota">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
