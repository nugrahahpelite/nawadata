<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoZonaMs.aspx.vb" Inherits="SBSto.WbfSsoZonaMs" MasterPageFile="~/SBSto.Master" Title="SB WMS : Master Zona" %>
                        ...
                        <tr>
                            <td style="vertical-align:top; width: 585px;">
                                <table style="font-family:tahoma;font-size:12px;">
                                    <tr>
                                        <td></td>
                                        <td style="font-size:15px;height:28px" colspan="3"><strong>MASTER ZONA</strong></td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style3"></td>
                                        <td class="auto-style4">ID Zona</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 24px">Nama Zona</td>
                                        <td style="height: 24px">:</td>
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px"><asp:TextBox ID="TxtZonaName" runat="server" Width="214px" Font-Names="Tahoma" Font-Size="12px" MaxLength="50" CssClass="setuppercase"></asp:TextBox></td>
                                                    <td style="height: 20px">
                                                        <asp:Label ID="LblMsgZonaName" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="auto-style2"></td>
                                        <td style="height: 24px">Deskripsi Zona</td>
                                        <td style="height: 24px">:</td>
                                        <td style="height: 24px">
                                            <table>
                                                <tr>
                                                    <td style="height: 20px"><asp:TextBox ID="TxtZonaDescr" runat="server" Width="214px" Font-Names="Tahoma" Font-Size="12px" MaxLength="200" CssClass="setuppercase" Height="45px" TextMode="MultiLine"></asp:TextBox></td>
                                                    <td style="height: 20px">
                                            <asp:Label ID="LblMsgZonaDescr" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <td style="vertical-align:top;height:100%">
                                <asp:Panel ID="PanList" class="myPanelGreyNSa" runat="server" Width="100%" style="height:500px" Visible="True">
                                    <table style="width: 90%;margin:auto;font-family: tahoma;font-size:11px">
                                        <tr>
                                            <td style="font-size:15px;height:28px" colspan="3"><strong>LIST ZONA</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView class="myPanelGreyLight" ID="GrvList" runat="server" AutoGenerateColumns="False" Width="945px" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" ShowHeaderWhenEmpty="True" CssClass="myGridViewHeaderFontWeightNormal" PageSize="25">
                                                    ...
                                                    <Columns>
                                                        <asp:ButtonField CommandName="Select" DataTextField="ZonaName" HeaderText="Nama Zona">
                                                            <HeaderStyle Width="145px" />
                                                        </asp:ButtonField>
                                                        <asp:BoundField DataField="ZonaDescription" HeaderText="Deskripsi Zona">
                                                            <HeaderStyle Width="145px" />
                                                        </asp:BoundField>
