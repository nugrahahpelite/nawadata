<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoDispatchDMDs.aspx.vb" Inherits="SBSto.WbfSsoDispatchDMDs" Title="SB WMS - Dispatch" MasterPageFile="~/SBSto.Master" %>
                ...
                <asp:Panel ID="PanWork" runat="server" style="height:525px">
                        ...
                        <table style="font-family:tahoma;font-size:12px;">
                            ...
                            <tr>
                                ...
                                <td style="width:420px">
                                    ...
                                    <asp:Button ID="BtnEdit" class="myButtonAct" runat="server" Text="Edit SKK" Width="90px" Height="30px" Font-Names="Tahoma" Font-Size="12px" Enabled="False" Visible="False" />
                    ...
                    <table>
                        <tr>
                            ...
                            <td colspan="3">
                                    ...
                                    <asp:Panel ID="PanList" class="myPanelGreyNS" runat="server" style="z-index:110;display:block;width:1650px;height:580px" Visible="True" BorderStyle="Solid" BackColor="White">
                                        <table style="width:85%;font-family: tahoma;font-size:11px">
                                            <tr>
                                                ...
                                                <td  style="width:115px;text-align:right">No. Dispatch/SKK: </td>
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="DcmSchNo" HeaderText="No. SKK">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                ...
                                <div id="DivSKK" runat="server" >
                                    <asp:Panel runat="server" ID="PanSKK" BorderColor="Gray" BorderStyle="Solid" style="z-index:10;display:block;width:850px;height:850px" BackColor="White" >
                                        <table style="margin-top:15px;margin-left:15px;margin-bottom:15px;width:95%">
                                            <tr>
                                                <td colspan="6" style="text-align:left"><asp:Label ID="Label1" runat="server" Text="Daftar SKK" Font-Bold="True"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td colspan="6" style="background-color:#808080;height:4px">
                                                    <asp:Label ID="LblSKKprogress" runat="server" Height="3px" Visible="False" Width="100%"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width:100px">
                                                    <asp:Button ID="BtnSKKFind" runat="server" class="myButtonFind" Font-Names="Tahoma" Font-Size="12px" Height="22px" Text="Cari" UseSubmitBehavior="False" Width="100px" />
                                                </td>
                                                <td>No. SKK 
                                                ...
                                                <td style="width:115px">
                                                    <asp:TextBox ID="TxtSKKFind" runat="server" BorderColor="#999999" BorderWidth="1px" MaxLength="85" TabIndex="5" Width="115px" autocomplete="off"></asp:TextBox>
                                                </td>
                                                <td style="width:100px">
                                                    <asp:Button ID="BtnSKKClose" runat="server" class="myButtonEasy" Font-Names="Tahoma" Font-Size="12px" Height="22px" Text="Close" UseSubmitBehavior="False" Width="100px" />
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="5">
                                                    <asp:Label ID="LblSKKError" runat="server" ForeColor="Red" Visible="False" Font-Size="10pt"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="6">
                                                    <asp:GridView ID="GrvSKK" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="40" ShowHeaderWhenEmpty="True">
                                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                        <Columns>
                                                            ...
                                                            <asp:ButtonField CommandName="DcmSchNo" DataTextField="DcmSchNo" HeaderText="No.SKK" Text="Button">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:ButtonField>
                                                            <asp:BoundField DataField="DcmschDate" HeaderText="Tanggal<br />SKK" HtmlEncode="false">
                                                                <HeaderStyle Width="80px" />
                                                                <ItemStyle HorizontalAlign="Center"/>
                                                            </asp:BoundField>
                                                                <asp:BoundField DataField="DcmschLeaveDate" HeaderText="Tanggal<br />Berangkat" HtmlEncode="false">
                                                                <HeaderStyle Width="80px" />
                                                                <ItemStyle HorizontalAlign="Center"/>
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="DcmSchDriverOID" HeaderText="Driver ID">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="DcmDriverName" HeaderText="Driver">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="VehicleOID" HeaderText="Vehicle OID">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="VehicleNo" HeaderText="Vehicle">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="VehicleTyeDescr" HeaderText="Tipe">
                                                                <HeaderStyle Width="75px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="SchHTypeOID" HeaderText="SchHTypeOID">
                                                                <HeaderStyle Width="75px" CssClass="myDisplayNone" />
                                                                <ItemStyle Width="75px" CssClass="myDisplayNone" />
                                                            </asp:BoundField>
                                                        </Columns>
                                                        <EditRowStyle BackColor="#999999" />
                                                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                    ...
                    <table runat="server" id="tbTrans" >
                        <tr>
                            ...
                            <td style="width:20px;text-align:center">:</td>
                            <td>
                                <asp:TextBox ID="TxtCompany" runat="server" BackColor="#E2E2E2" Font-Names="Tahoma" Font-Size="12px" ReadOnly="True" Width="285px"></asp:TextBox>
                            </td>
                            <td style="width:10px"></td>
                            <td>ID Transaksi</td>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">:</td>
                            <td>
                                <asp:TextBox ID="TxtSKKOID" runat="server" BackColor="#E2E2E2" Enabled="False" Font-Names="Tahoma" Font-Size="12px" Width="70px"></asp:TextBox>
                                <asp:TextBox ID="TxtSKKNo" runat="server" BackColor="#E2E2E2" Font-Names="Tahoma" Font-Size="12px" ReadOnly="True" Width="185px"></asp:TextBox>
                                <asp:Button ID="BtnSKK" runat="server" Font-Names="Tahoma" Font-Size="12px" Height="23px" Text="..." Width="40px" Visible="False" />
                            </td>
                            <td>&nbsp;</td>
                            <td>Driver</td>                         
                            <td style="text-align:center">:</td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><asp:HiddenField ID="HdfDcmSchHOID" runat="server" /></td>
                            <td><asp:HiddenField ID="HdfDcmSchDriverOID" runat="server" /></td>
                            <td><asp:HiddenField ID="HdfDcmVehicleOID" runat="server" Value="0" /></td>
                        </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
