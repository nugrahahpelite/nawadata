<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoRcvKar.aspx.vb" Inherits="SBSto.WbfSsoRcvKar" Title="SB WMS - Penerimaan Karantina" MasterPageFile="~/SBSto.Master" %>
                    ...
                    <asp:Panel ID="PanButtonH" runat="server">
                        <table style="font-family:tahoma;font-size:12px;">
                            <tr>
                                ...
                                <td style="font-size:15px;height:28px" colspan="3"><strong>PENERIMAAN KARANTINA</strong></td>                                
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                &nbsp;&nbsp;&nbsp;<asp:CheckBox ID="ChkSt_Approved" runat="server" Checked="True" ForeColor="#336600" Text="Approved" />
&nbsp; <asp:CheckBox ID="ChkSt_OnReceive" runat="server" ForeColor="#336600" Text="On Receive" Checked="True" />
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:ButtonField CommandName="Select" DataTextField="RcvKRNo" Text="Button" HeaderText="Nomor Penerimaan">
                                                                <HeaderStyle Width="125px" />
                                                                <ItemStyle Font-Underline="True" ForeColor="#0033CC" />
                                                            </asp:ButtonField>
                                                            <asp:BoundField DataField="vRcvKRDate" HeaderText="Tanggal Penerimaan" >
                                                                <HeaderStyle Width="65px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="RcvPONo" HeaderText="Penerimaan Pembelian" >
                                                                <HeaderStyle Width="65px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="RcvPOSupplierName" HeaderText="Supplier" >
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="RcvKRCompanyCode" HeaderText="Company" >
                                                                <HeaderStyle Width="65px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="RcvKRNote" HeaderText="Note" >
                                                                <HeaderStyle Width="120px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="RcvKRTypeName" HeaderText="Receive Type" >
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                                ...
                                <div id="DivListBrg" runat="server" >
                                    <asp:Panel ID="PanListBrg" class="myPanelGreyNS" runat="server" style="z-index:84;display:block;width:725px;height:580px;margin-left:100px;margin-top:50px" Visible="True" BorderStyle="Solid" BackColor="White" >
                                        <table style="font-family: tahoma;font-size:11px">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvListBrg" runat="server" AutoGenerateColumns="False" CellPadding="4" class="myPanelGreyLight" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="15" ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="StickyHeader">
                                                        <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                       <Columns>
                                                            <%-- 0 --%>
                                                            <asp:ButtonField CommandName="BRGCODE" DataTextField="BRGCODE" HeaderText="Kode Barang">
                                                                <HeaderStyle Width="100px" />
                                                            <ItemStyle ForeColor="#005AE1" />
                                                            </asp:ButtonField>
                                                            <%-- 1 --%>
                                                            ...
                                                            <%-- 3 --%>
                                                            <asp:BoundField DataField="vQtyKrOutstanding" HeaderText="Qty Outstanding<br />Karantina" DataFormatString="{0:n0}" HtmlEncode="false">
                                                                <HeaderStyle Width="80px" />
                                                                <ItemStyle HorizontalAlign="Center" />
                                                            </asp:BoundField>
                                                            <%-- 4 --%>
                                                            <asp:BoundField DataField="STKRHOID" HeaderText="Stock Karantina<br />OID" HtmlEncode="false">
                                ...
                                <div id="DivLsRcvPO" runat="server" >
                                    <asp:Panel ID="PanLsRcvPO" class="myPanelGreyNS" runat="server" style="z-index:145;display:block;width:525px;height:580px;margin-left:10px;margin-top:0px" Visible="True" BorderStyle="Solid" BackColor="White">
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvLsRcvPO" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" class="myPanelGreyLight" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="RcvRefTypeOID" HeaderText="RcvRefTypeOID" HtmlEncode="false">
                                                                <HeaderStyle CssClass="myDisplayNone" />
                                                                <ItemStyle CssClass="myDisplayNone" />
                                                            </asp:BoundField>
                                                        </Columns>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="width:20px;text-align:center">:</td>
                            <td>
                                <asp:TextBox ID="TxtTransStatus" runat="server" BackColor="#DDDDDD" Font-Names="Tahoma" Font-Size="12px" Width="165px" ReadOnly="True"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">:</td>
                            <td>
                                <asp:TextBox ID="TxtRcvPONo" runat="server" Font-Names="Tahoma" Font-Size="12px" ReadOnly="True" Width="190px"></asp:TextBox>
                                <asp:Button ID="BtnRcvPONo" runat="server" Font-Names="Tahoma" Font-Size="12px" Height="23px" Text="..." Width="40px" />
                            </td>   
                            <td></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:TextBox ID="TxtBrgCode" runat="server" Enabled="false" Font-Names="Tahoma" Font-Size="12px" Visible="false"></asp:TextBox>
                            </td>
                            <td style="text-align:center">&nbsp;</td>
                            <td></td>
                            <td colspan="7">
                                <asp:RadioButton ID="RdbTypeRelease" runat="server" ForeColor="#990000" Text="RELEASE Karantina Minus" AutoPostBack="True" />
                                &nbsp;
                                <asp:RadioButton ID="RdbTypeMinus" runat="server" ForeColor="#0066FF" Text="Receive Karantina Minus" AutoPostBack="True" />
                                &nbsp;<asp:RadioButton ID="RdbTypePlus" runat="server" ForeColor="#009933" Text="Receive Karantina Plus" AutoPostBack="True" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label ID="LblMsgType" runat="server" ForeColor="Red"></asp:Label>
                            </td>
                        </tr>
                        <tr style="vertical-align:top">
                            <td></td>
                                ...
                                <td>
                                    <asp:GridView ID="GrvDetail" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="StickyHeader">
                                        ...
                                        <Columns>
                                            ...
                                            <%-- 4 --%>
                                            <asp:BoundField DataField="RcvKRQty" HeaderText="Qty Terima" DataFormatString="{0:n0}" >
                                                <HeaderStyle Width="80px" />
                                                <ItemStyle HorizontalAlign="Right" />
                                            </asp:BoundField>
                                            <%-- 5 --%>
                                            <asp:TemplateField HeaderText="Qty Terima">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="TxtRcvKRQty" Width="100px" MaxLength="10"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- 6 --%>
                                            ...
                                            <%-- 8 --%>
                                            <asp:BoundField DataField="vMessage" HeaderText="" >
                                                <HeaderStyle Width="145px" />
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:HiddenField ID="HdfRcvPOHOID" runat="server" />
                            </td>
                            <td>
                                <asp:HiddenField ID="HdfRcvKRTypeOID" runat="server" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
