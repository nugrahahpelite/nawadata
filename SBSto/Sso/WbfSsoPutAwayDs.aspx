<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoPutAwayDs.aspx.vb" Inherits="SBSto.WbfSsoPutAwayDs" Title="SB WMS - Putaway Gudang Sama" MasterPageFile="~/SBSto.Master" %>
                    ...
                    <asp:Panel ID="PanButtonH" runat="server">
                        <table style="font-family:tahoma;font-size:12px;">
                            <tr>
                                ...
                                <td style="font-size:15px;height:28px" colspan="3"><strong>PUTAWAY GUDANG SAMA</strong></td>                                
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="BtnCancelPW" runat="server" class="myButtonAct" Enabled="False" Font-Names="Tahoma" Font-Size="12px" Height="30px" Text="Batal Putaway" Width="120px" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                    ...
                                    <asp:Panel ID="PanList" class="myPanelGreyNS" runat="server" style="z-index:110;display:block;width:1650px;height:580px" Visible="True" BorderStyle="Solid" BackColor="White">
                                        <table style="width:85%;font-family: tahoma;font-size:11px">
                                            <tr>
                                                ...
                                                <td  style="width:115px;text-align:right">Nomor Putaway : </td>
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PWCompanyCode" HeaderText="Company" HtmlEncode="false">
                                                                <HeaderStyle Width="55px" />
                                                            </asp:BoundField>
                                                            <asp:ButtonField CommandName="PWNo" DataTextField="PWNo" HeaderText="No.Putaway" Text="Button">
                                                            ...
                                                            <asp:BoundField DataField="vPWDate" HeaderText="Tanggal<br />Putaway" HtmlEncode="false">
                                                            ...
                                                            <asp:BoundField DataField="PWCancelNote" HeaderText="Cancel Note">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                            ...
                            <td>
                                <asp:GridView ID="GrvSumm" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                    ...
                                    <Columns>
                                        ...
                                        <%-- 2 --%>
                                        <asp:BoundField DataField="vSumPWScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 1" HtmlEncode="false">
                                            <HeaderStyle Width="50px" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <%-- 3 --%>
                                        <asp:BoundField DataField="vSumPWScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 2" HtmlEncode="false">
                                            <HeaderStyle Width="50px" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                    </Columns>
                                            ...
                                            <td colspan="6">
                                                <asp:GridView ID="GrvData1" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- 1 --%>
                                                        <asp:BoundField DataField="PWScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 2 --%>
                                                        <asp:BoundField DataField="PWScan1Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="vPWScan1User" HeaderText="Scan By">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="vPWScan1Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        ...
                                                        <%-- 6 --%>
                                                        <asp:BoundField DataField="vPWScan1Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 7 --%>
                                                        <asp:BoundField DataField="vPWScan1DeletedUser" HeaderText="Deleted By">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="PWScan1DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="vPWScan1DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                ...
                                                <asp:GridView ID="GrvData2" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True" Visible="False">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- 2 --%>
                                                        <asp:BoundField DataField="PWScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="PWScan2Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="vPWScan2User" HeaderText="Scan By">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        <asp:BoundField DataField="vPWScan2Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%-- 6 --%>
                                                        ...
                                                        <%-- 7 --%>
                                                        <asp:BoundField DataField="vPWScan2Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="vPWScan2DeletedUser" HeaderText="Deleted By">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="PWScan2DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 10 --%>
                                                        <asp:BoundField DataField="vPWScan2DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
