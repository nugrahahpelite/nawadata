<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoSNRequestPrint.aspx.vb" Inherits="SBSto.WbfSsoSNRequestPrint" MasterPageFile="~/SBSto.Master" Title="SB WMS : Print Request SN QR" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="CtpRight">
    <!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>SB SO : Print Request SN QR</title>
        ...
        <script type="text/javascript">
            function fsShowInProgress(vriProcess) {
                ...
                document.getElementById("<%= BtnBrgCode.ClientID%>").style.display = "none";
                            ...
                            <td style="vertical-align:top; width: 585px;">
                                <table style="font-family:tahoma;font-size:12px;">
                                    <tr>
                                        ...
                                        <td style="font-size:15px;height:28px" colspan="5"><strong>REQUEST PRINT SERIAL NO</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Company</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="TxtPrintSN" runat="server" Font-Names="Tahoma" Font-Size="12px" Width="145px"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="LblMsgPrintSN" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="BtnPrint" class="myButtonAct" runat="server" Text="Print" Width="116px" Height="30px" Font-Names="Tahoma" ForeColor="Blue" Font-Size="12px" OnClientClick="fsShowInProgress('')" />
                                                    </td>
                                                    <td></td>
                                                    <td>
                                                        <asp:Button ID="BtnClear" class="myButtonAct" runat="server" Text="Clear" Width="116px" Height="30px" Font-Names="Tahoma" ForeColor="White" Font-Size="12px" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <td style="vertical-align:top;height:100%">
                                <asp:Panel ID="PanList" class="myPanelGreyNSa" runat="server" Width="100%" style="height:500px" Visible="True">
                                    <table style="width: 90%;margin:auto;font-family: tahoma;font-size:11px">
                                        <tr>
                                            <td style="font-size:15px;height:28px" colspan="3"><strong>HISTORY REQUEST PRINT SERIAL NO</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td colspan="5">
                                                            <asp:CheckBox ID="ChkPrinted" runat="server" Checked="True" ForeColor="#0066FF" Text="Tampilkan HANYA Request BELUM Print" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Barang</td>
                                                        <td>:</td>
                                                        <td><asp:TextBox ID="TxtListBarang" runat="server" Width="145px" Font-Names="Tahoma" Font-Size="12px"></asp:TextBox></td>
                                                        <td></td>
                                                        <td>Serial No.</td>
                                                        <td>:</td>
                                                        <td><asp:TextBox ID="TxtListSN" runat="server" Width="145px" Font-Names="Tahoma" Font-Size="12px"></asp:TextBox></td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView class="myPanelGreyLight" ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" ShowHeaderWhenEmpty="True" CssClass="myGridViewHeaderFontWeightNormal" PageSize="25" Width="945px">
                                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                    <Columns>
                                                        <asp:ButtonField CommandName="Select" DataTextField="OID" HeaderText="OID">
                                                         <HeaderStyle Width="55px" />
                                                        </asp:ButtonField>
                                                        <asp:BoundField DataField="CompanyCode" HeaderText="Company" >
                                                            <HeaderStyle Width="70px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ReqSNWarehouseOID" HeaderText="ReqSNWarehouseOID" >
                                                            <HeaderStyle Width="80px" CssClass="myDisplayNone" />
                                                            <ItemStyle Width="80px" CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="ReqSN" HeaderText="Request SN">
                                                            <HeaderStyle Width="145px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ReqSNNote" HeaderText="Request Note">
                                                            <HeaderStyle Width="145px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="ReqSNDatetime" HeaderText="Request Datetime">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="vReqSNUserName" HeaderText="Request User Name">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="PrintSNDatetime" HeaderText="Print Datetime">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="vPrintSNUserName" HeaderText="Print User Name">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                    <EditRowStyle BackColor="#999999" />
