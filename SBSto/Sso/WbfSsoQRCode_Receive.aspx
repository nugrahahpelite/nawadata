<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoQRCode_Receive.aspx.vb" Inherits="SBSto.WbfSsoQRCode_Receive" MasterPageFile="~/SBSto.Master" Title="SB WMS : Print QR" %>
                            ...
                            <td style="vertical-align:top; width: 585px;">
                                <table style="font-family:tahoma;font-size:12px;">
                                    <tr>
                                        ...
                                        <td style="font-size:15px;height:28px" colspan="5"><strong>PRINT QR PENERIMAAN PEMBELIAN</strong></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>Company</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="TxtRcvPONo" runat="server" Font-Names="Tahoma" Font-Size="12px" Width="185px" BackColor="#DBDBDB" ReadOnly="True"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="TxtRcvPODate" runat="server" Font-Names="Tahoma" Font-Size="12px" Width="100px" BackColor="#DBDBDB" ReadOnly="True"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="BtnRcvPO" runat="server" Font-Names="Tahoma" Font-Size="12px" Height="23px" Text="..." Width="40px" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="LblMsgRcvPO" runat="server" ForeColor="Red" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:HiddenField ID="HdfRcvPORefTypeOID" runat="server" />
                                                    </td>
                                                    <td>
                                                        <asp:HiddenField ID="HdfRcvRefTypeOID" runat="server" />
                                                    </td>
                                                    <td>
                                                        <asp:HiddenField ID="HdfRcvPORefOID" runat="server" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                            ...
                                                            <td colspan="2">
                                                                <asp:GridView ID="GrvLsRcvPO" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="4" class="myPanelGreyLight" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField DataField="RcvPORefOID" HeaderText="RcvPORefOID" HtmlEncode="false">
                                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                                            <ItemStyle CssClass="myDisplayNone" />
                                                                        </asp:BoundField>
                                                                    </Columns>
                            ...
                            <td style="vertical-align:top;height:100%">
                                <asp:Panel ID="PanList" class="myPanelGreyNSa" runat="server" Width="100%" style="height:500px" Visible="True">
                                    <table style="width: 90%;margin:auto;font-family: tahoma;font-size:11px">
                                        <tr>
                                            <td style="font-size:15px;height:28px" colspan="3"><strong>HISTORY PRINT QR PENERIMAAN PEMBELIAN</strong></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:TextBox ID="TxtListPenerimaan" runat="server" Font-Names="Tahoma" Font-Size="12px" Width="176px"></asp:TextBox>
                                                                    </td>
                                                                    <td></td>
                                                                    <td>Barang</td>
                                                                    <td>:</td>
                                                                    <td>
                                                                        <asp:TextBox ID="TxtListBarang" runat="server" Font-Names="Tahoma" Font-Size="12px" Width="176px"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                            ...
                                            <td>
                                                <asp:GridView class="myPanelGreyLight" ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" ShowHeaderWhenEmpty="True" CssClass="myGridViewHeaderFontWeightNormal" PageSize="25">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RcvPONo" HeaderText="No.Penerimaan" >
                                                            <HeaderStyle Width="80px" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="vRcvPODate" HeaderText="Tanggal<br />Penerimaan" HtmlEncode="false">
                                                            <HeaderStyle Width="80px" />
