<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WbfSsoMoveLocDs.aspx.vb" Inherits="SBSto.WbfSsoMoveLocDs" Title="SB WMS - Pindah Lokasi Gudang Sama" MasterPageFile="~/SBSto.Master" %>
                ...
                <asp:Panel ID="PanWork" runat="server" style="height:525px">
                    <asp:Panel ID="PanButtonH" runat="server">
                        <table style="font-family:tahoma;font-size:12px;">
                            <tr>
                                ...
                                <td style="font-size:15px;height:28px" colspan="3"><strong>PINDAH LOKASI GUDANG SAMA</strong></td>                                
                            </tr>
                            <tr>
                                <td style="width:10px"></td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="BtnCancelPDL" runat="server" class="myButtonAct" Enabled="False" Font-Names="Tahoma" Font-Size="12px" Height="30px" Text="Batal Pindah Lokasi" Width="120px" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                                ...
                                                <td colspan="2">
                                                    <asp:GridView ID="GrvList" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" AllowPaging="True" Font-Names="Tahoma" Font-Size="11px" CssClass="myGridViewHeaderFontWeightNormal" ShowHeaderWhenEmpty="True" PageSize="20">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PDLCompanyCode" HeaderText="Company" HtmlEncode="false">
                                                                <HeaderStyle Width="55px" />
                                                            </asp:BoundField>
                                                            <asp:ButtonField CommandName="PDLNo" DataTextField="PDLNo" HeaderText="No.Pindah Lokasi" Text="Button">
                                                                <HeaderStyle Width="100px" />
                                                                <ItemStyle ForeColor="#0033CC" />
                                                            </asp:ButtonField>
                                                            <asp:BoundField DataField="vPDLDate" HeaderText="Tanggal<br />Pindah Lokasi" HtmlEncode="false">
                                                            ...
                                                            <asp:BoundField DataField="PDLCancelNote" HeaderText="Cancel Note">
                                                                <HeaderStyle Width="100px" />
                                                            </asp:BoundField>
                            ...
                            <td>
                                <asp:GridView ID="GrvSumm" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                    ...
                                    <Columns>
                                        ...
                                        <%-- 4 --%>
                                        <asp:BoundField DataField="vSumPDLScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 1" HtmlEncode="false">
                                            <HeaderStyle Width="50px" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                        <%-- 5 --%>
                                        <asp:BoundField DataField="vSumPDLScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty<br />Scan 2" HtmlEncode="false">
                                            <HeaderStyle Width="50px" />
                                            <ItemStyle HorizontalAlign="Right" />
                                        </asp:BoundField>
                                    </Columns>
                                            ...
                                            <td colspan="6">
                                                <asp:GridView ID="GrvData1" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="PDLScan1Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="PDLScan1Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        <asp:BoundField DataField="vPDLScan1User" HeaderText="Scan By">
                                                            <HeaderStyle Width="100px" CssClass="myDisplayNone" />
                                                            <ItemStyle Width="100px" CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 6 --%>
                                                        <asp:BoundField DataField="vPDLScan1Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%-- 7 --%>
                                                        ...
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="vPDLScan1Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="PDLScan1DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 10 --%>
                                                        <asp:BoundField DataField="vPDLScan1DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                                                ...
                                                <asp:GridView ID="GrvData2" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="myGridViewHeaderFontWeightNormal" Font-Names="Tahoma" Font-Size="11px" ForeColor="#333333" PageSize="20" ShowHeaderWhenEmpty="True" Visible="False">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%-- 3 --%>
                                                        <asp:BoundField DataField="PDLScan2Qty" DataFormatString="{0:n0}" HeaderText="Qty Scan">
                                                            <HeaderStyle Width="50px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundField>
                                                        <%-- 4 --%>
                                                        <asp:BoundField DataField="PDLScan2Note" HeaderText="Note.">
                                                            <HeaderStyle CssClass="myDisplayNone" />
                                                            <ItemStyle CssClass="myDisplayNone" />
                                                        </asp:BoundField>
                                                        <%-- 5 --%>
                                                        <asp:BoundField DataField="vPDLScan2User" HeaderText="Scan By">
                                                            <HeaderStyle CssClass="myDisplayNone" Width="100px" />
                                                            <ItemStyle CssClass="myDisplayNone" Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 6 --%>
                                                        <asp:BoundField DataField="vPDLScan2Time" HeaderText="Scan Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <%-- 7 --%>
                                                        ...
                                                        <%-- 8 --%>
                                                        <asp:BoundField DataField="vPDLScan2Deleted" HeaderText="Deleted">
                                                            <HeaderStyle Width="45px" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:BoundField>
                                                        <%-- 9 --%>
                                                        <asp:BoundField DataField="PDLScan2DeletedNote" HeaderText="Delete Note">
                                                            <HeaderStyle Width="100px" />
                                                        </asp:BoundField>
                                                        <%-- 10 --%>
                                                        <asp:BoundField DataField="vPDLScan2DeletedTime" HeaderText="Deleted Time">
                                                            <HeaderStyle Width="100px" />
                                                            <ItemStyle HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                    </Columns>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><asp:HiddenField ID="HdfDetailRowIdx" runat="server" Value="0" /></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
